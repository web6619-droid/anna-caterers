...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white selection:bg-gold selection:text-black">
      <Header />
      <FloatingActions />
      ...
      <section className="relative pt-40 pb-24 overflow-hidden border-b border-white/5">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none opacity-[0.02] select-none overflow-hidden">
          <h1 className="text-[12rem] md:text-[20rem] font-black tracking-tighter whitespace-nowrap text-white">ANNA CATERERS</h1>
        </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {["Wedding Catering", "Corporate Events", "Birthday Parties", "Private Dining", "Cultural Feasts"].map((tag) => (
                  <span key={tag} className="px-5 py-2.5 rounded-full bg-[#1a1a1a] border border-white/10 text-sm font-medium text-white hover:border-gold/50 transition-colors cursor-default">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 h-[600px]">
              <div className="space-y-4 h-full">
                <div className="relative h-2/5 w-full rounded-2xl overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=2069&auto=format&fit=crop" alt="Fine Dining" fill className="object-cover" />
                </div>
                <div className="relative h-3/5 w-full rounded-2xl overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=2070&auto=format&fit=crop" alt="Plating" fill className="object-cover" />
                </div>
              </div>
              <div className="relative h-full w-full rounded-2xl overflow-hidden mt-8">
                <Image src="https://images.unsplash.com/photo-1555244162-803834f70033?q=80&w=2070&auto=format&fit=crop" alt="Gourmet Dish" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-[#0f0f0f] border-t border-white/5">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-5">
            ...
            <Link href="/services" className="px-8 py-4 bg-transparent border border-gold text-gold font-semibold rounded-full hover:bg-gold/10 transition-all tracking-wide">
              Our Services
            </Link>
          </div>
        </div>
