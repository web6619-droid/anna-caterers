...
export default function ServicesManagerTab({ showToast }: ServicesManagerTabProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 animate-fadeIn items-start">
      ...
      <div className="lg:col-span-1 bg-[#18181B] border border-white/5 w-full max-w-full overflow-hidden p-4 md:p-8 rounded-2xl md:rounded-3xl h-fit shadow-2xl lg:sticky lg:top-28 max-h-[85vh] overflow-y-auto lg:max-h-none lg:overflow-visible pr-2 custom-scrollbar">
        <div className="flex items-center gap-2 text-[#D4AF37] font-semibold text-xs uppercase tracking-widest mb-2">
          <Sparkles className="w-4 h-4 shrink-0" /> <span>Package Configuration</span>
        </div>
        <h3 className="text-xl md:text-2xl font-bold text-white tracking-tight mb-4 md:mb-6">Add Event Service</h3>
        
        <form onSubmit={handleAddService} className="space-y-3.5 md:space-y-5 w-full max-w-full">
          <div className="w-full">
            <label className="flex items-center gap-1.5 text-[11px] md:text-xs font-semibold text-gray-300 uppercase tracking-wider mb-1.5 md:mb-2">
              <Type className="w-3.5 h-3.5 text-[#D4AF37] shrink-0" /> Service Name
            </label>
            <input
              type="text"
              required
          ...
          <div className="w-full">
            <label className="flex items-center gap-1.5 text-[11px] md:text-xs font-semibold text-gray-300 uppercase tracking-wider mb-1.5 md:mb-2">
              <FileText className="w-3.5 h-3.5 text-[#D4AF37] shrink-0" /> Package Description
            </label>
            <textarea
              required
              rows={3}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 md:gap-4 w-full">
            <div className="w-full">
              <label className="flex items-center gap-1.5 text-[11px] md:text-xs font-semibold text-gray-300 uppercase tracking-wider mb-1.5 md:mb-2">
                <DollarSign className="w-3.5 h-3.5 text-[#D4AF37] shrink-0" /> Price Display
              </label>
              <input
                type="text"
                required
            ...
            <div className="w-full">
              <label className="flex items-center gap-1.5 text-[11px] md:text-xs font-semibold text-gray-300 uppercase tracking-wider mb-1.5 md:mb-2 truncate">
                <Smile className="w-3.5 h-3.5 text-[#D4AF37] shrink-0" /> EMOJI ICON (OPTIONAL)
              </label>
              <input
                type="text"
                value={emoji}
